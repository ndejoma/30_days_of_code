...
function main(){
    ...
    var s=readLine();
    var len=s.length;
    console.log(s, "The string")
    // create the Solution class object p
    var obj=new Solution();
    //push/enqueue all the characters of string s to stack
    for(var i=0;i<len;i++){
      console.log(s.charAt(i), "The string character")
